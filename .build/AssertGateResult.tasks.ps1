...
# picking up the remainder via the structural QA suites. Set to the REAL total (1204,
# Task 3.2's TP.INT.0011 port round), matching the module's own post-fix Pester run.
$script:tenantPulseGateMinimumTests = 1204
