...
BeforeAll {
    ...
    function New-PulsePublishFixture {
        ...
        # total="1973" tracks scripts/Publish-TenantPulsePackage.ps1's own -MinimumTests
...
<test-results name="TenantPulse $Version" total="1973" failures="0" errors="0" skipped="0">
