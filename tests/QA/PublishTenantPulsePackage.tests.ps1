<#
    ...
    The NUnit/PesterObject test-result fixture is fabricated (not a real 1402+ test Pester
...
BeforeAll {
    ...
    function New-PulsePublishFixture {
        ...
        # Assert-GateResult.ps1's own whole-result checks pass without a real 1402-test run.
        # total="1402" tracks scripts/Publish-TenantPulsePackage.ps1's own -MinimumTests
...
<test-results name="TenantPulse $Version" total="1402" failures="0" errors="0" skipped="0">
