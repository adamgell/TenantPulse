...
BeforeAll {
    ...
    function New-PulsePublishFixture {
        ...
        # total="2015" tracks scripts/Publish-TenantPulsePackage.ps1's own -MinimumTests
...
<test-results name="TenantPulse $Version" total="2015" failures="0" errors="0" skipped="0">
