<#
    ...
    The NUnit/PesterObject test-result fixture is fabricated (not a real 1325+ test Pester
...
BeforeAll {
    ...
    function New-PulsePublishFixture {
        ...
        # Assert-GateResult.ps1's own whole-result checks pass without a real 1325-test run.
        # total="1325" tracks scripts/Publish-TenantPulsePackage.ps1's own -MinimumTests
...
<test-results name="TenantPulse $Version" total="1325" failures="0" errors="0" skipped="0">
