<#
    ...
    The NUnit/PesterObject test-result fixture is fabricated (not a real 707+ test Pester
...
BeforeAll {
    ...
    function New-PulsePublishFixture {
        ...
        # Assert-GateResult.ps1's own whole-result checks pass without a real 707-test run.
        $resultPath = Join-Path $testResultsDir "NUnitXml_TenantPulse_v$Version.Fixture.xml"
        $nunitXml = @"
<?xml version="1.0" encoding="utf-8"?>
<test-results name="TenantPulse $Version" total="707" failures="0" errors="0" skipped="0">
