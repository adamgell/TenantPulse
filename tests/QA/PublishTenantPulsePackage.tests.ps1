...
"@
        ...
        # total="3615" tracks scripts/Publish-TenantPulsePackage.ps1's own -MinimumTests
        ...
        $nunitXml = @"
<?xml version="1.0" encoding="utf-8"?>
<test-results name="TenantPulse $Version" total="3615" failures="0" errors="0" skipped="0">
