...
"@
        ...
        # Assert-GateResult.ps1's whole-result checks pass without running the real full suite.
        # total="3648" tracks scripts/Publish-TenantPulsePackage.ps1's own -MinimumTests
        ...
        $nunitXml = @"
<?xml version="1.0" encoding="utf-8"?>
<test-results name="TenantPulse $Version" total="3648" failures="0" errors="0" skipped="0">
