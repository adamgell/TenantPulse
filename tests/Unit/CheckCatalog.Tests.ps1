...
Describe 'Import-PulseCheckCatalog' {
    ...
    It 'loads and validates the module''s own default catalog path cleanly (Task 1.9 seed checks + Task 3.1''s TP.INT.0006 + Task 3.2''s TP.INT.0007-0009/0011-0014, self-check)' {
