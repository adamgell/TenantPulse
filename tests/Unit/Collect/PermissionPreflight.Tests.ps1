...
Describe 'Get-PulsePermissionPreflightOperations' {
    ...
    It 'unions ordinary descriptors, composite children, expansion operations, and app-health additions' {
        ...
        $keys | Should -Contain 'GroupPolicyConfiguration/ListBeta'
        $keys | Should -Contain 'GroupPolicyDefinitionValue/ListBeta'
        $keys | Should -Contain 'GroupPolicyPresentationValue/ListBeta'
