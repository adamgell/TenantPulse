@{
    ...
    Impact     = 'Low'
    Data       = @{
        Datasets = @('managedDeviceCleanupRules')
        Gates    = @('Intune')
    }
    Rule       = @{
        Type     = 'Function'
    ...
    References = @{
        ...
        Authorities = @(
            ...
            'https://learn.microsoft.com/en-us/graph/api/resources/intune-devices-manageddevicecleanuprule?view=graph-rest-beta'
        )
    }
