@{
    ...
    Consulting = @{
        ...
        Remediation  = @(
            'Identify which policy this finding''s Reason names as carrying (or failing to carry) the correct value, and confirm it is assigned to the intended device population in the Intune admin center.'
